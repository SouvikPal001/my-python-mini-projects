...
match choice:
    case 1:
        print("You chose One")  #Note: In python, there is no need to include break statement after each case, if one case is matched, that's it, it won't go any further and come out of the match cases
    case 2:
        print("You chose Two")
    case 3:
